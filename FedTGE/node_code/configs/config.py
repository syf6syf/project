...
def args_parser():
    ...
    parser.add_argument('--freq_threshold', type=float, default=3.0, help='Threshold for frequency analysis')
    ...
    parser.add_argument('--dataset', type=str, default='Cora',
                        help='Dataset',
                        choices=[ 'Cora','Pubmed', 'Cs','Physics','photo'])  # Reddit
    ...
    parser.add_argument('--agg_method', type=str, default="EnergyBelief",
                        help='Federated Algorithms')#FedAvg
    ...
    parser.add_argument('--is_test', type=int, default=1, help='Server-side energy propagation weight')
    parser.add_argument('--tau', type=float, default=0.85, help='Server-side energy propagation weight')#0.85
    parser.add_argument('--round', type=int, default=1, help='Server-side energy propagation weight')
